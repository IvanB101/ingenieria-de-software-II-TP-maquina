 ...
 * @author ivanb
 */
public class EliminarPlan extends javax.swing.JPanel {
    ...
    private void TablaExamenesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaExamenesMouseClicked
        switch (JOptionPane.showConfirmDialog(this, "Esta seguro de que desea borrar el plan de estudios (codigo: "
                + TablaExamenes.getValueAt(TablaExamenes.getSelectedRow(), 0) + "),\n se borrara toda la informacion"
                + "relacionada al mismo")) {
            case JOptionPane.OK_OPTION:
                try {
                    PlanEstudiosManager.eliminar((String) TablaExamenes.getValueAt(TablaExamenes.getSelectedRow(), 0));
